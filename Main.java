...
//-----------------------------------------------------------------
	...
	return;
      ...
      {
	System.out.
	  println ("You're a Senior Citizen, so we arrange a Lower Berth");
	...
	TicketBook.aLB--;
      ...
      {
	System.out.
	  println ("You Have a child, so we arrange the Lower Berth");
	tb.bookTicket (p, (TicketBook.lBP.get (0)), "L");
	TicketBook.lBP.remove (0);
	TicketBook.aLB--;
      }
//-------------------------BERTHS------------------------------------
    else if ((p.bp.equals ("L") && TicketBook.aLB > 0)
	     || (p.bp.equals ("M") && TicketBook.aMB > 0)
	     || (p.bp.equals ("U") && TicketBook.aUB > 0))
      {
	if (p.bp.equals ("L"))
	  {
		  ...
		  if (gchoice == 1)
		    {
		      ...
		      System.out.
			println
			("Enter the Passenger Berth Preference: [L, M, U]");
		      String bp = sc.next ();
		      Passenger p =
			new Passenger (name, age, gender, cname, cage, bp);
		      bookTicket (p);
		    }
		  else if (gchoice == 2)
		    {
